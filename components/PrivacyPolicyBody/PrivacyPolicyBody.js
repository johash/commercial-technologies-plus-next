import classes from "./PrivacyPolicyBody.module.scss";

const PrivacyPolicyBody = () => {
  return (
    <section className={classes.PrivacyPolicyBody}>
      <div className={classes.Container}>
        ...
        <div className={classes.TextContent}>
          <div>
            <h6>Introduction</h6>
            <p>Welcome to Commercial Technologies Plus (Private) Limited.</p>
            <p>
              Commercial Technologies Plus (Private) Limited (“us”, “we”, or
              “our”) operates https://commercialtp.com (hereinafter referred to
              as “Service”).
            </p>
            <p>
              Our Privacy Policy governs your visit to https://commercialtp.com,
          ...
          <div>
            <h6>Definitions</h6>
            <p>
              SERVICE means the https://commercialtp.com website operated by
              Commercial Technologies Plus (Private) Limited.
            </p>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              or by emailing at info@commercialtp.com.
            </p>
            <b>Usage Data</b>
            <p>
          ...
          <div>
            <h6>Use of Data</h6>
            <p>
              Commercial Technologies Plus (Private) Limited uses the collected
          ...
          <div>
            ...
            <p>
              Commercial Technologies Plus (Private) Limited will take all the
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <p>
                  {
                    "(d)	users are able to change their personal information by emailing us at info@commercialtp.com. "
                  }
                </p>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <p>
                  (c) To stop selling your personal information. We do not sell
                  your personal information for monetary consideration. However,
                  under some circumstances, a transfer of personal information
                  to a third party, or within our family of companies, without
          ...
          <div>
            ...
            <p>
              Commercial Technologies Plus (Private) Limited uses remarketing
          ...
          <div>
            ...
            <p>
              ...
              https://www.commercialtp.com/contact-us.
            </p>
          </div>
        </div>
      </div>
