...
import classes from "./BillableEcommerceDevelopment.module.scss";
import DevCard from "./DevCard/DevCard";

const BillableEcommerceDevelopment = () => {
  return (
    <section className={classes.BillableEcommerceDevelopment}>
      <div className={classes.Container}>
        <div className={classes.ImageContainer}>
          <Image
            alt="billable ecommerce development and commitment"
            src={"/assets/ecommerce-development.png"}
            layout="fill"
...
export default BillableEcommerceDevelopment;
