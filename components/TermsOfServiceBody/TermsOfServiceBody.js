import classes from "./TermsOfServiceBody.module.scss";

const TermsOfServiceBody = () => {
  return (
    <section className={classes.TermsOfServiceBody}>
      <div className={classes.Container}>
        <div className={classes.EffectiveDate}>
        ...
        <div className={classes.TextContent}>
          <div>
            <h6>Introduction</h6>
            <p>
              Welcome to Commercial Technologies Plus (Private) Limited
              (“Company”, “we”, “our”, “us”)! As you have just clicked our Terms
            ...
            <p>
              ...
              use of our web pages located at https://commercialtp.com and our
              mobile application Saas Service Apps (together or individually
              “Service”) operated by Commercial Technologies Plus (Private)
              Limited.
            </p>
            <p>
              ...
              https://commercialtp.com/privacy-policy.
            </p>
            <p>
            ...
            <p>
              ...
              info@commercialtp.com so we can try to find a solution. These
          ...
          <div>
            ...
            <p>
              ...
              automatically authorize Commercial Technologies Plus (Private)
              Limited to charge all Subscription fees incurred through your
              account to any such payment instruments.
            </p>
            <p>
              Should automatic billing fail to occur for any reason, Commercial
              Technologies Plus (Private) Limited will issue an electronic
              invoice indicating that you must proceed manually, within a
          ...
          <div>
            <h6>Free Trial</h6>
            <p>
              Commercial Technologies Plus (Private) Limited may, at its sole
            ...
            <p>
              ...
              Trial, you will not be charged by Commercial Technologies Plus
              (Private) Limited until Free Trial has expired. On the last day of
              Free Trial period, unless you cancelled your Subscription, you
              will be automatically charged the applicable Subscription fees for
              the type of Subscription you have selected.
            </p>
            <p>
              At any time and without notice, Commercial Technologies Plus
          ...
          <div>
            <h6>Fee Changes</h6>
            <p>
              Commercial Technologies Plus (Private) Limited, in its sole
            ...
            <p>
              Commercial Technologies Plus (Private) Limited will provide you
              with a reasonable prior notice of any change in Subscription fees
              to give you an opportunity to terminate your Subscription before
          ...
          <div>
            ...
            <p>
              Commercial Technologies Plus (Private) Limited has the right but
            ...
            <p>
              ...
              property of Commercial Technologies Plus (Private) Limited or used
          ...
          <div>
            ...
            <p>
              ...
              exclusive property of Commercial Technologies Plus (Private)
              Limited and its licensors. Service is protected by copyright,
              ...
              service without the prior written consent of Commercial
              Technologies Plus (Private) Limited.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              via email to privacy@commercialtp.com, with the subject line:
          ...
          <div>
            <h6>DMCA Notice and Procedure for Copyright Infringement Claims</h6>
            <p>
            ...
            <p>
              ...
              privacy@commercialtp.com
            </p>
          </div>
          <div>
            <h6>Error Reporting and Feedback</h6>
            <p>
              You may provide us either directly at info@commercialtp.com or via
          ...
          <div>
            ...
            <p>
              ...
              that are not owned or controlled by Commercial Technologies Plus
              (Private) Limited.
            </p>
            <p>
              Commercial Technologies Plus (Private) Limited has no control
            ...
            <p>
              YOU ACKNOWLEDGE AND AGREE THAT COMMERCIAL TECHNOLOGIES PLUS
          ...
          <div>
            ...
            <p>By email: info@commercialtp.com.</p>
          </div>
        </div>
      </div>
    </section>
